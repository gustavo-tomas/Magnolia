...
namespace mag
{
    inline btVector3 mag_to_bt(const math::vec3& v)
    {
    ...
    inline math::vec3 bt_to_mag(const btVector3& bt_vec)
    {
    ...
    inline btQuaternion mag_to_bt(const math::quat& q)
    {
    ...
    inline math::quat bt_to_mag(const btQuaternion& bt_quat)
    {
    ...
    inline btTransform mag_to_bt(const math::vec3& position, const math::quat& rotation)
    {
