...
namespace mag
{
    ...
    std::shared_ptr<Model> ModelLoader::load(const str& file)
    {
        ...
        for (u32 m = 0; m < scene->mNumMeshes; m++)
        {
            ...
            for (u32 i = 0; i < material->GetTextureCount(aiTextureType_DIFFUSE); i++)
            {
                ...
                // Textures
                auto texture = Application::get().get_texture_loader().load(directory + "/" + material_name);
    ...
    void Cube::initialize()
    {
        ...
        auto diffuse_texture = Application::get().get_texture_loader().load("assets/images/DefaultAlbedoSeamless.png");
