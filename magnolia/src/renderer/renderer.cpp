...
namespace mag
{
    void Renderer::initialize(Window& window)
    {
        ...
        camera.initialize(vec3(10.35f, 5.13f, 10.35f), vec3(-20.0f, -45.0f, 0.0f), 60.0f, window.get_size(), 0.1f,
                          1000.0f);
    ...
    void Renderer::update(Model* model, Editor& editor, const f32 dt)
    {
