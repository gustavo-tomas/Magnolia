...
namespace mag
{
    namespace window
    {
        ...
        inline i32 mag_to_sdl(const Button button)
        {
            switch (button)
            {
        ...
        inline Button sdl_to_mag_button(const i32 sdl_button)
        {
            switch (sdl_button)
            {
        ...
        inline SDL_Keycode mag_to_sdl(Key key)
        {
            switch (key)
            {
        ...
        inline Key sdl_to_mag_key(SDL_Keycode sdl_keycode)
        {
            switch (sdl_keycode)
            {
