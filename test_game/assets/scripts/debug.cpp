...
class Debug : public ScriptableEntity
{
    public:
        void on_create() override
        {
            ...
            LOG_SUCCESS("Created Debug");
        }

        void on_destroy() override { LOG_SUCCESS("Destroyed Debug"); }
        ...
        void draw_colliders(const f32 dt)
        {
            mag::Camera& camera = get_camera();
        ...
        void draw_floor(const f32 dt)
        {
            auto light_entities = get_all_components_of_types<TransformComponent, LightComponent>();
        ...
        void build_shader(const str& file_path, const b8 recompile)
        {
...
extern "C" ScriptableEntity* create_script() { return new Debug(); }
