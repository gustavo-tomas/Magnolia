...
// @TODO: for now this is just a simplified model. we will (hopefully) add some juicy GI in the future 
...
vec4 pbr_shading(Material material,
                 vec4 texture_color,
                 vec4 texture_roughness,
                 vec4 texture_metalness,
                 vec3 normal,
                 ...
                 vec3 light_color)
{
    ...
    vec3 v = normalize(camera_position - frag_position);    // Vector from surface point to camera
